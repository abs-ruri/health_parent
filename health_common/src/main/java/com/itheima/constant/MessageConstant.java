...
public class MessageConstant {
    ...
    public static final String ADD_MENU_FAIL = "新增检查项失败";
    public static final String ADD_MENU_SUCCESS = "新增检查项成功";
    public static final String EDIT_CHECKITEM_FAIL = "编辑检查项失败";
    public static final String EDIT_SETMEAL_FAIL = "编辑检查套餐失败";
    ...
    public static final String DELETE_SETMEAL_FAIL = "删除检查套餐失败";
    public static final String DELETE_SETMEAL_SUCCESS = "删除检查套餐成功";
    ...
    public static final String ORDER_FAIL = "网络不稳定，请刷新后再试";
    ...
    public static final String GET_USER_SUCCESS = "获取用户数据成功";
    public static final String GET_USER_FAIL = "获取用户数据失败";
    ...
    public static final String GET_ROLE_LIST_FAIL = "查询角色列表数据失败";
    public static final String GET_ROLE_LIST_SUCCESS = "查询角色列表数据成功";
    public static final String GET_ROLE="查询所有角色成功";
    public static final String Fail="查询permission失败";
